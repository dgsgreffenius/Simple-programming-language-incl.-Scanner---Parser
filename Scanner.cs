...
public class Scanner {
	...
	void CheckLiteral() {
		switch (t.val) {
			case "constant": t.kind = 7; break;
			case "true": t.kind = 15; break;
			case "false": t.kind = 16; break;
			case "void": t.kind = 19; break;
			...
			case "to": t.kind = 38; break;
			case "program": t.kind = 39; break;
			case "int": t.kind = 40; break;
			case "bool": t.kind = 41; break;
			case "string": t.kind = 42; break;
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 3:
				...
				else if (ch == '!' || ch >= '#' && ch <= '~') {AddCh(); goto case 3;}
				else {goto case 0;}
			case 4:
				if (ch >= '!' && ch <= '~') {AddCh(); goto case 5;}
				else {goto case 0;}
			case 5:
				if (ch == 39) {AddCh(); goto case 6;}
				else {goto case 0;}
			case 6:
				{t.kind = 4; break;}
			case 7:
